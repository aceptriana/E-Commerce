        ...
        <div class="card-body">
            <form action="<?= base_url('admin/kategori/update/' . $kategori['id']); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control-file" id="foto_kategori" name="foto_kategori" accept="image/*">
                </div>

                <?php if (!empty($kategori['foto_kategori']) && file_exists($kategori['foto_kategori'])) : ?>
                    <div class="form-group">
                        <label>Foto Saat Ini:</label><br>
                        <img src="<?= base_url($kategori['foto_kategori']); ?>" alt="Foto Kategori" width="150" height="150" style="object-fit: cover;">
                    </div>
                <?php endif; ?>
