...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Dashboard Pemilik Mantra Jaya Tani</h1>
        <a href="<?= base_url('pemilik/laporan/penjualan/cetak') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Penjualan (Bulan Ini)</div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Pendapatan (Tahun Ini)</div>
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="<?= base_url('pemilik/laporan/penjualan/cetak') ?>">Ekspor ke PDF</a>
                            <a class="dropdown-item" href="<?= base_url('pemilik/laporan/penjualan/cetak') ?>">Ekspor ke Excel</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="<?= base_url('pemilik/laporan/produk?limit=5') ?>">Tampilkan 5 Teratas</a>
                            <a class="dropdown-item" href="<?= base_url('pemilik/laporan/produk?limit=10') ?>">Tampilkan 10 Teratas</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <hr>
                    <a href="<?= base_url('pemilik/laporan/penjualan') ?>" class="btn btn-primary btn-block">
...
<!-- Re-use the pemilik JS charts code -->
<script>
